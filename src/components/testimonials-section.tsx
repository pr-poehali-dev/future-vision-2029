...
export function TestimonialsSection() {
  ...
  return (
    <section id="reviews" className="py-12 sm:py-24 px-4 sm:px-6 bg-card">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8 sm:mb-16">
          <h2 className="text-2xl sm:text-4xl font-bold text-card-foreground mb-3 sm:mb-4 font-sans">Отзывы клиентов</h2>
